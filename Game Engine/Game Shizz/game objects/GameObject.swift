...
extension GameObject {
    ...
    public func setMaterialAmbient(_ r: Float, g: Float, b: Float) { setMaterialAmbient(float3(r, b, b))}
    ...
    public func setMaterialDiffuse(_ r: Float, g: Float, b: Float) { setMaterialDiffuse(float3(r, b, b))}
    ...
    public func setMaterialSpecular(_ r: Float, g: Float, b: Float) { setMaterialSpecular(float3(r, b, b))}
